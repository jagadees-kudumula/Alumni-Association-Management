...
function SignupAlumni() {
    ...
    const handleAlumniLoginClick = () => {
        navigate('/login/alumni'); // Navigate to the student login page
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setTimeout(() => navigate('/login/alumni'), 800); // Redirect to login after 0.8 seconds
            } else {
        ...
        <div className="signup-page">
            ...
            <div className="signup-form-container">
                <div className="signup-form-card">
                    <h2 className="signup-form-title">Alumni Sign Up</h2>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-field">
                            <label htmlFor="passoutYear"><FontAwesomeIcon icon={faCalendar} />Passout Year</label>
                            <input
                                type="text"
                                id="passoutYear"

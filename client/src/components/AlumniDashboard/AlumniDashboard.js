...
import './AlumniDashboard.css'; // Adjust the path for CSS
...
function AlumniDashboard() {
  ...
  const handleLogout = () => {
    ...
    localStorage.removeItem('alumni-refresh-token');
    ...
    <div className="container-fluid bg-light min-vh-100 d-flex">
      ...
      >
        <div className="sidebar-sticky p-3">
          <h4 className="text-center mb-4">Alumni Portal</h4>
  ...
  <div className="flex-grow-1 text-center"> {/* Centering the title */}
    <h1 className="h3 text-primary mb-0"> Alumni Dashboard</h1>
  </div>
         
          <div className="ms-auto">
          <a onClick={handleLogout}><span className="badge bg-primary p-2  justify-content-right align-items-right ">LogOut</span></a>
          <a onClick={handleHome}><span className="badge bg-primary p-2  justify-content-right align-items-right ">Home</span></a>
          </div>
          </header>
